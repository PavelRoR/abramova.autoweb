...
<head>
    ...
    <meta property="og:url" content="https://abramova.mastervision.su/metaphysics-webinar/promo-b/" />
    <meta property="og:title" content="Вы зарегистрированы на мастер-класс" />
    <title>Вы зарегистрированы на мастер-класс</title>
...
<body>
    ...
    <section id="main">
        <div class="container">
            <p class="pre-b">Вы зарегистрированы на мастер-класс</p>
            <h1 class="main-title"> <span>Метафизика - </span><small> 3 шага к восстановлению </small>души и тела</h1>
            <p class="main-date">Старт с <?php echo $dateDay1Text;?> по <?php echo $dateDay2Text;?> <?php echo $dateMonthText;?>, в 19:00мск</p>
        </div>
    </section>
    <section id="second">
        <div class="container">
            ...
            <form class="form"
                ...
                <div style="display: none;">
                    ...
                    <!-- API код канала рекламы --><input type="hidden" value="0"
                        ...
                        value="132" /><input type="hidden" name="formVc" value="3602203720" />
                </div>
            </form>
        </div>
    </section>
