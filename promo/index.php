...
<head>
    ...
    <meta property="og:url" content="https://abramova.mastervision.su/metaphysics-webinar/promo/" />
    <meta property="og:title" content="Оставьте свои данные чтобы получить рабочие тетради и таблицы для предстоящего мастер-класса" />
    <title>Оставьте свои данные чтобы получить рабочие тетради и таблицы для предстоящего мастер-класса</title>
...
<body>
    ...
    <section id="main">
        <div class="container">
            ...
            <p class="main-date">с <?php echo $dateDay1Text;?> по <?php echo $dateDay2Text;?> <?php echo $dateMonthText;?>, в 19:00мск</p>
            <p class="main-author">Автор: <span>Жанна Абрамова</span></p>
        </div>
    </section>
    <section id="second">
        <div class="container">
            <p class="second-text">Оставьте свои данные, чтобы получить рабочие тетради и таблицы для предстоящего мастер-класса "Метафизика- 3 шага к востановлению души и тела". Данные материалы понадобяться вам для продуктивной работы.<br />+</p>
            <p class="second-text"> <span>Бонус</span><br />Книга Яро Старак, Тони Кей, Джеймс Олдхейм</p>
            <p class="second-text bonus-name">"ТЕХНИКИ ГЕШТАЛЬТ-ТЕРАПИИ НА КАЖДЫЙ ДЕНЬ"</p>
            <form class="form"
                action="https://shop.mastervision.su/?r=personal/newsletter/data/add&amp;id=3568&amp;lg=ru"
                method="post" enctype="application/x-www-form-urlencoded" accept-charset="UTF-8"><input type="hidden"
                    value="1" id="required_fields_phone_number" name="required_fields[phone_number]" /><input
                    class="mail form-mail" name="Contact[phone_number]" type="text" placeholder="Ваш телефон" /><button
                    class="button button-form" type="submit">Получить материалы</button>
                <p class="alert-message"> </p>
                <div class="checking checking-form"><input class="check" type="checkbox" id="check_m"
                        checked="checked" /><label class="check-label" for="check_m">Я согласен с <a
                            href="javascript:void(0);" data-toggle="modal" data-target="#myPolitics"> условиями обработки персональных данных</a> по 152 - Ф3</label></div>
                <div style="display: none;">
                    ...
                    <!-- API код канала рекламы --><input type="hidden" value="0"
                        ...
                        value="130" /><input type="hidden" name="formVc" value="428845021" />
                </div>
            </form>
        </div>
    </section>
    ...
    <script src="../js/promo.min.js"></script><!-- AutoWebOffice: UTM or OpenStat Counter -->
    <script type="text/javascript">
